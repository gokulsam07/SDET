...
public class Sep14LCHW_DigitCountValueEqual {
	//ip: String
	//op: boolean
	//Logic
	//1. init int[] of size 10
	//2. Run for loop to calculate the frequency of occurance of the digit & store in int[] using  freq[num.charAt(i)-48]++;
	//3. Run one more for loop for num.length to check if element at freq[i] and element at charAt(i)-48 are not equal
	//if yes return false
	//return true for method
